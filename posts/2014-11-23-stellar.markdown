---
title: Stellar for Haskell
author: Bob Long
---

[Stellar](https://www.stellar.org/) calls itself "public infrastructure for money". While investigating how it works, I decided
to produce Haskell bindings so that I could interact with it through GHCi. I'm pretty happy with how
it's turning out:

<ul>
  <li><a href="https://github.com/bobjflong/stellar-haskell">Stellar on Github</a></li>
</ul>

You'll first need to set OverloadedStrings in GHCi:
